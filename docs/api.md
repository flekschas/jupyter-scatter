...
| `color`                                  | str \| str[] \| [float, float, float, float] \| [float, float, float, float][]                                                       | `True`                                   |            |           |               |
| `color_selected`                         | str \| str[] \| [float, float, float, float] \| [float, float, float, float][]                                                       | `True`                                   |            |           |               |
| `color_hover`                            | str \| str[] \| [float, float, float, float] \| [float, float, float, float][]                                                       | `True`                                   |            |           |               |
| `color_by`                               | `"valueA"` \| `"valueB"`                                                                                                             | `None`                                   | `True`     |           |               |
| `opacity`                                | float \| float[]                                                                                                                     | `0.66`                                   |            |           |               |
| `opacity_unselected`                     | float \| float[]                                                                                                                     | `0.5`                                    |            |           |               |
| `opacity_by`                             | `"valueA"` \| `"valueB"` \| `"density"`                                                                                              |                                          | `True`     |           |               |
| `size`                                   | int \| int[] \| float \| float[]                                                                                                     |                                          | `True`     |           |               |
| `size_active`                            | int                                                                                                                                  |                                          | `True`     |           |               |
| `size_by`                                | `"valueA"` \| `"valueB"`                                                                                                             |                                           | `True`     |           |               |
| `connect`                                | bool                                                                                                                                 | `False`                                   | `True`     |           |               |
| `connection_color`                       | str \| str[] \| [float, float, float, float] \| [float, float, float, float][]                                                       | `None`                                   | `True`     |           |               |
| `connection_color_selected`              | str \| str[] \| [float, float, float, float] \| [float, float, float, float][]                                                       | `None`                                   | `True`     |           |               |
| `connection_color_hover`                 | str \| str[] \| [float, float, float, float] \| [float, float, float, float][]                                                       | `None`                                   | `True`     |           |               |
| `connection_opacity`                     | float \| float[]                                                                                                                     | `None`                                   | `True`     |           |               |
| `connection_opacity_by`                  | `"valueA"` \| `"valueB"` \| `"segment"`                                                                                              | `None`                                   | `True`     |           |               |
| `connection_size`                        | int \| int[] \| float \| float[]                                                                                                     | `None`                                   | `True`     |           |               |
| `connection_size_by`                     | `"valueA"` \| `"valueB"` \| `"segment"`                                                                                              | `None`                                   | `True`     |           |               |
| `width`                                  | int \| `"auto"`                                                                                                                      | `"auto"`                                 | `True`     |           |               |
| `height`                                 | int                                                                                                                                  | `240`                                    | `True`     |           |               |
| `background_color`                       | `"valueA"` \| `"valueB"` \| `density`                                                                                                | `None`                                   | `True`     |           |               |
| `background_image`                       | str \| [float, float, float, float]                                                                                                  | `"white"`                                | `True`     |           |               |
| `lasso_color`                            | str \| [float, float, float, float]                                                                                                  | `[0, 0.666666667, 1, 1]`                 | `True`     |           |               |
| `lasso_min_delay`                        | int                                                                                                                                  | `10`                                     | `True`     |           |               |
| `lasso_min_dist`                         | float                                                                                                                                | `3`                                      | `True`     |           |               |
| `reticle`                                | bool                                                                                                                                 | `True`                                   | `True`     |           |               |
| `reticle_color`                          | str \| [float, float, float, float] \| `"auto"`                                                                                      | `"auto"`                                 | `True`     |           |               |
| `other_options`                          | dict                                                                                                                                 |                                          | `True`     |           | For setting other [regl-scatterplot properties](https://github.com/flekschas/regl-scatterplot/?tab=readme-ov-file#properties). Note that whatever is defined in options will be overwritten by the short-hand options |
| `view_reset`                             | bool                                                                                                                                 | `False`                                  | `True`     |           |               |
| `view_download`                          | bool                                                                                                                                 | `False`                                  | `True`     |           |               |
| `view_data`                              | int[]                                                                                                                                | `None`                                   | `True`     |           | [Uint8ClampedArray](https://developer.mozilla.org/en-US/docs/Web/API/ImageData/data) |
| `view_shape`                             | [int, int]                                                                                                                           | `None`                                   | `True`     |           |               |
| `view_sync`                              | str                                                                                                                                  |                                          | `True`     |           | For synchronyzing view changes across scatter plot instances |
